...
import com.flx.flxoa.common.util.VerifyCodeUtils;
...
public class AuthImageController {
	...
	@ResponseBody
	public String AuthImage(HttpServletRequest request, HttpServletResponse response,ModelMap model) throws ServletException, IOException {
