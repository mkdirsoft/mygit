...
/**
 * This is an object that contains data related to the flxoa_system_user_group_department table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="flxoa_system_user_group_department"
 */

public abstract class BaseFlxoaSystemUserGroupDepartment  implements Serializable {

	public static String REF = "FlxoaSystemUserGroupDepartment";
	...
	// constructors
	public BaseFlxoaSystemUserGroupDepartment () {
		initialize();
	}
	 ...
	 */
	public BaseFlxoaSystemUserGroupDepartment (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.flx.flxoa.info.system.entity.FlxoaSystemUserGroupDepartment)) return false;
		else {
			com.flx.flxoa.info.system.entity.FlxoaSystemUserGroupDepartment flxoaSystemUserGroupDepartment = (com.flx.flxoa.info.system.entity.FlxoaSystemUserGroupDepartment) obj;
			if (null == this.getId() || null == flxoaSystemUserGroupDepartment.getId()) return false;
			else return (this.getId().equals(flxoaSystemUserGroupDepartment.getId()));
		}
	}
