package com.flx.flxoa.info.contractmanagement.dao;
...
/**
 *
 * 类名称：FlxoaContractInformationDao.java
 * 类描述：
 ...
 *@author 夏改翠 
 */ 
public interface FlxoaContractInformationDao {
	/**
