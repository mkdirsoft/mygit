package com.flx.flxoa.info.approve.manager;
...
/**
 *
 * 类名称：FlxoaApproveConditionWorkflowService.java
 * 类描述：
 ...
 *@author 刘凯 
 */ 
public interface FlxoaApproveConditionWorkflowService {
	/**
	 ...
	 */	
	FlxoaApproveConditionWorkflow queryByEntity(FlxoaApproveConditionWorkflow flxoaApproveConditionWorkflow);
