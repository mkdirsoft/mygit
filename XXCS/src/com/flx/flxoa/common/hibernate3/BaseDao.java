...
/**
 * @author 刘凯
 * @date 2018-3-8 下午4:13:28
 * 描述：
 * IbaseDao实现类
 */
@SuppressWarnings({ "rawtypes", "unchecked" })
public abstract class BaseDao<T, ID extends Serializable> extends HibernateSimpleDao implements IBaseDao<T, ID> {
    ...
    @Override
    public T get(ID id) {
        T load = (T) super.getSession().get(getEntityClass(), id);
        return load;
    }
