...
public class StaticPeram {
	...
	final static String Timeout = "1000000";
	// 初始化ascClient需要的几个参数
	...
	// 替换成你的AK (产品密)
	final static String accessKeyId = "LTAIp7R5T20at83X";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
	final static String accessKeySecret = "kR9o8Dc5HPWhN8EpifULoDq2OVViOd";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
	// 必填:短信签名-可在短信控制台中找到
	final static String SignName = "阿里云短信测试专用"; // 阿里云配置你自己的短信签名填入
	// 必填:短信模板-可在短信控制台中找到
	final static String TemplateCode = "SMS_120285006"; // 阿里云配置你自己的短信模板填入
