...
/**
 * This is an object that contains data related to the flxoa_system_user_role table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="flxoa_system_user_role"
 */

public abstract class BaseFlxoaSystemUserRole  implements Serializable {

	public static String REF = "FlxoaSystemUserRole";
	...
	// constructors
	public BaseFlxoaSystemUserRole () {
		initialize();
	}
	 ...
	 */
	public BaseFlxoaSystemUserRole (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.flx.flxoa.info.system.entity.FlxoaSystemUserRole)) return false;
		else {
			com.flx.flxoa.info.system.entity.FlxoaSystemUserRole flxoaSystemUserRole = (com.flx.flxoa.info.system.entity.FlxoaSystemUserRole) obj;
			if (null == this.getId() || null == flxoaSystemUserRole.getId()) return false;
			else return (this.getId().equals(flxoaSystemUserRole.getId()));
		}
	}
