...
/**
 * This is an object that contains data related to the flxoa_system_user_group_role table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="flxoa_system_user_group_role"
 */

public abstract class BaseFlxoaSystemUserGroupRole  implements Serializable {

	public static String REF = "FlxoaSystemUserGroupRole";
	...
	// constructors
	public BaseFlxoaSystemUserGroupRole () {
		initialize();
	}
	 ...
	 */
	public BaseFlxoaSystemUserGroupRole (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.flx.flxoa.info.system.entity.FlxoaSystemUserGroupRole)) return false;
		else {
			com.flx.flxoa.info.system.entity.FlxoaSystemUserGroupRole flxoaSystemUserGroupRole = (com.flx.flxoa.info.system.entity.FlxoaSystemUserGroupRole) obj;
			if (null == this.getId() || null == flxoaSystemUserGroupRole.getId()) return false;
			else return (this.getId().equals(flxoaSystemUserGroupRole.getId()));
		}
	}
