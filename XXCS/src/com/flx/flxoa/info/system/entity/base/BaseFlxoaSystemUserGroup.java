...
/**
 * This is an object that contains data related to the flxoa_system_user_group table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="flxoa_system_user_group"
 */

public abstract class BaseFlxoaSystemUserGroup  implements Serializable {

	public static String REF = "FlxoaSystemUserGroup";
	...
	// constructors
	public BaseFlxoaSystemUserGroup () {
		initialize();
	}
	 ...
	 */
	public BaseFlxoaSystemUserGroup (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.flx.flxoa.info.system.entity.FlxoaSystemUserGroup)) return false;
		else {
			com.flx.flxoa.info.system.entity.FlxoaSystemUserGroup flxoaSystemUserGroup = (com.flx.flxoa.info.system.entity.FlxoaSystemUserGroup) obj;
			if (null == this.getId() || null == flxoaSystemUserGroup.getId()) return false;
			else return (this.getId().equals(flxoaSystemUserGroup.getId()));
		}
	}
