...
/**
 * This is an object that contains data related to the flxoa_approve_formtemplate table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="flxoa_approve_formtemplate"
 */

public abstract class BaseFlxoaApproveFormtemplate  implements Serializable {

	public static String REF = "FlxoaApproveFormtemplate";
	...
	// constructors
	public BaseFlxoaApproveFormtemplate () {
		initialize();
	}
	 ...
	 */
	public BaseFlxoaApproveFormtemplate (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.flx.flxoa.info.approve.entity.FlxoaApproveFormtemplate)) return false;
		else {
			com.flx.flxoa.info.approve.entity.FlxoaApproveFormtemplate flxoaApproveFormtemplate = (com.flx.flxoa.info.approve.entity.FlxoaApproveFormtemplate) obj;
			if (null == this.getId() || null == flxoaApproveFormtemplate.getId()) return false;
			else return (this.getId().equals(flxoaApproveFormtemplate.getId()));
		}
	}
